            ...
            for year in years:
                ...
                for group in groups:
                    ...
                    if year < current_year:
                        ...
                        months_divisor = current_month - 1
                        if months_divisor < 1:
                            months_divisor = 0
                    else:
                        months_divisor = 0
                    ...
                    if months_divisor > 0:
                        sold_average_month = total_amount / months_divisor if total_amount else 0
                        profit_average_month = profit / months_divisor if profit else 0
                        average_selling_cost = (total_amount - profit) / months_divisor if total_amount else 0
                        inventory_average_u = sum(inventory_close_u_month.values()) / months_divisor
                        inventory_average_p = sum(inventory_close_p_month.values()) / months_divisor
                    else:
                        sold_average_month = 0
                        profit_average_month = 0
                        average_selling_cost = 0
                        inventory_average_u = 0
                        inventory_average_p = 0
